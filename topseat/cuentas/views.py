...
'''
    Vistas de la aplicacion de cuentas.
    Esta aplicacion hace el manejo de las cuentas, tanto creacion, modificacion, eliminacion, cerrar sesion e ingresar al sistema.
...
def login_v(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request,'cuentas/login.html',{'lgForm':form,'error':form.errors})
    else:
...
def actualizarContrasena(request):
    ...
    if request.method == 'POST':
        ...
        datos['cgForm']=form
    return render(request, 'cuentas/cambiarContrasena.html',datos)
...
def actualizarPerfil(request):
    ...
    if request.method == 'POST':
        ...
        form = editarUsuario()
        datos['cgForm']=form
    return render(request, 'cuentas/editarPerfil.html',datos)
